...
public class ControlerTest {
	...
	public void testCadastraAluno() {
		...
		String cadastroAluno1 = controle.cadastraAluno("118110386", "José Alisson", "Ciencia da computação");
		String cadastroAluno2 = controle.cadastraAluno("118110386", "José Alisson", "Ciencia da computação");
	...
	public void testContemAluno() {
		Controler controle = new Controler();
		controle.cadastraAluno("118110386", "José Alisson", "Ciencia da computação");
		assertEquals(controle.consultarAluno("000000000"), "\nAluno não cadastrado.");
		assertEquals(controle.consultarAluno("118110386"),
				"\nAluno: 118110386 - José Alisson - Ciencia da computação");
	}
