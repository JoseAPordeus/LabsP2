...
class AlunoTest {
	...
	public void testAluno() {
		Aluno aluno1 = new Aluno("118110386", "Alisson", "Ciencia da computação");
	...
	public void testEqualsObject() {
		Aluno aluno1 = new Aluno("118110386", "Alisson Araujo", "Ciencia da computação");
		Aluno aluno2 = new Aluno("118110666", "Exu Caveirinha", "Infernologia");
		Aluno aluno3 = new Aluno("118110386", "Alisson Araujo", "Ciencia da computação");
		assertEquals(aluno1.equals(aluno2), false);
